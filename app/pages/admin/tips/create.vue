<template>
  <div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
      ...
      <p class="text-gray-600 mt-1">Add a new betting tip for users</p>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="bg-white rounded-lg shadow-md p-6">
      <div class="space-y-6">
        ...
        <div>
          ...
          />
          <p class="text-xs text-gray-500 mt-1">Enter the match fixture</p>
        </div>
        ...
        <!-- Reasoning -->
        <div>
          <label class="label">Reasoning (Optional)</label>
          <textarea
          ...
          ></textarea>
          <p class="text-xs text-gray-500 mt-1">
            Detailed reasoning helps users understand your prediction
          </p>
        </div>
      ...
      <div class="flex gap-4 mt-8">
        <button
          ...
          class="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-semibold disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
